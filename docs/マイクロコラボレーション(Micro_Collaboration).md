...
# 概要
 ...
 - マイクロコラボレーションが起こりやすいとき:
    - Ans: 前進したいとき
        ...
        - etc
    - 別の言い方をすると、[レイリー(Raily)](レイリー(Raily).md)な状況かつ個を軽視すると起きやすいと思います<a href="sta.md"><img src="sta.png" alt="sta" width="16"/></a>
...
# たとえば:
 ...
 - [ギャランティよりもベストエフォート]
    ...
    - このスタイルにするためには、意思決定者の認知体力が要る。要は予実管理という数字さえ見てれば誰でもできるし自分の意見も介さずに済む「楽な仕事」ではなく、毎回状況を見て次何するかを議論していく「頭を使う仕事」をしなければならない。それができるだけの体力が要る
        - そのためにも私は[スラック(Slack)](スラック(Slack).md)が必要であると考えています<a href="sta.md"><img src="sta.png" alt="sta" width="16"/></a>
