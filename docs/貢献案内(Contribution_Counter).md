...
# 概要
 - ペルソナとは:
    ...
    - したい人 or できる人、のどちらを使うかは好みだが、統一はした方が良い<a href="sta.md"><img src="sta.png" alt="sta" width="16"/></a>
 - 貢献案内には以下の実装がある
...
# 貢献案内のポイント（ペルソナリストの場合）
 ...
 - ペルソナページ内の構造とフォーマットも端的に統一する
    ...
    - etc
    - 情報を全部詰め込むか、リンクに飛ばしてペルソナページ自体はリンク集にするかはトレードオフである。一つ言えるとすれば、「まずはペルソナページを見れば良い」と言える状態をキープすることから逃げないことである。なので、雑にリンクを並べている程度では、ペルソナページとは言えない<a href="sta.md"><img src="sta.png" alt="sta" width="16"/></a>
